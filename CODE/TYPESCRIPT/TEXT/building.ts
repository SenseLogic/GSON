...
import type { BuildGsonContext, JsonValue } from "./types.ts";
...
function getEscapedLine(
    line: string,
    primedTextIsEscaped: boolean = true
    )
    : string
{
...
function buildGsonString(
    value: string,
    primedTextIsGenerated: boolean = true,
    primedTextIsEscaped: boolean = true,
    context: BuildGsonContext,
    level: number,
    lineSuffix: string = ""
    )
    : void
...
export function buildGsonText(
    ...
    primedTextIsGenerated: boolean = true,
    primedTextIsEscaped: boolean = true,
    indentationSpaceCount: number = 4
    )
    : string
{
    let context: BuildGsonContext =
        {
