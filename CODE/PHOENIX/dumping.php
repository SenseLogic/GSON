    ...
    )
{
              ...
              && array_is_list( $value ) )
    {
        ...
        {
             $text = "[\n";
             $indent = getIndentationText( ( $level + 1 ) * $levelSpaceCount );
